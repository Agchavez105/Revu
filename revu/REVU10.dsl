workspace "Revu" "Sistema de reseña de lugares" {
  ...
  model {
    ...
    revu = softwareSystem "Revu" "Software para realizar , mostrar y analisar reseñas sobre lugares " "Revu" {
      ...
      busquedaResenasBC = container "Busqueda de reseñas Bounded Context" "Permite la busqueda de reseñas a segun las preferencias del usuario" "Express.js / ECMAScript v2024" "BusquedaReseñasBC,BoundedContext"{
        ...
        busquedaResenasController = component "busquedaResenas Controller" "RESTful API Controller class de busquedaResenas" "Class / Express.js / ECMAScript v2024" "busquedaResenasController,Controller"

   



        group "busquedaResenas" {

          busquedaResenasQueryService = component "busquedaResenas QueryService" "Business Logic del query de busquedaResenas" "Class / Express.js / ECMAScript v2024" "GestionUsuarioQueryService,Service"

          busquedaResenasCommandService = component "busquedaResenas CommandService" "Business Logic del Command de busquedaResenas" "Class / Express.js / ECMAScript v2024" "GestionUsuarioCommandService,Service"

          busquedaResenasRepository = component "busquedaResenas Repository" "Repository Interface de busquedaResenas" "Interface / Express.js / ECMAScript v2024" "GestionUsuarioRepository,Repository"

          busquedaResenasQuery = component "busquedaResenas Query" "Query for read busquedaResenas" "Record" "GestionUsuarioeQuery, Query"

          busquedaResenasCommand = component "busquedaResenas Command" "Command for create, update and delete busquedaResenas" "Record" "busquedaResenasCommand, Command"
        ...
        #  googleTranslateService = component "googleTranslate Api ExternalService" "External Business Logic de traduccion" "Class / Express.js / ECMAScript v2024" "googleTranslateExternalService,ExternalService"

           lecturaResenaService = component "Lectura reseña External service" "External Business Logic de lectura de reseña" "Class / Express.js / ECMAScript v2024" "PublicarExternalService,ExternalService"
      ...
      lecturaResenasBC = container "Lectura de Reseñas Bounded Context" "Permite al usuario visualizar reseñas de otrso usuarios así como su Informacion" "Express.js / ECMAScript v2024" "LecturaReseñasBC,BoundedContext" {
        ...
        lecturaResenasController = component "lecturaResenas Controller" "RESTful API Controller class de lecturaResenas" "Class / Express.js / ECMAScript v2024" "lecturaResenasController,Controller"

   



        group "lecturaResenas" {

          lecturaResenasQueryService = component "lecturaResenas QueryService" "Business Logic del query de lecturaResenas" "Class / Express.js / ECMAScript v2024" "lecturaResenasQueryService,Service"

          lecturaResenasCommandService = component "lecturaResenas CommandService" "Business Logic del Command de lecturaResenas" "Class / Express.js / ECMAScript v2024" "lecturaResenasCommandService,Service"

          lecturaResenasRepository = component "lecturaResenas Repository" "Repository Interface de lecturaResenas" "Interface / Express.js / ECMAScript v2024" "GestionUsuarioRepository,Repository"

          lecturaResenasQuery = component "lecturaResenas Query" "Query for read lecturaResenas" "Record" "GestionUsuarioeQuery, Query"

          lecturaResenasCommand = component "lecturaResenas Command" "Command for create, update and delete lecturaResenas" "Record" "busquedaResenasCommand, Command"
      ...
      group "Databases" {
        ...
        lecturaResenasDB = container "Lectura de reseñas Database" "Guarda información de las reseñas visitadas por el usuario" "Redis Database v7.4" "LescturaResenaDB,Database"
    ...
    lecturaResenasBC -> lecturaResenasDB "Guardar y recupera datos" "SQL Commands"
    ...
    # Relationship ComponentDiagram-busquedaResenas

    # --------------------------------------------------------

    apiGateway -> busquedaResenasController "Request Post del endpoint de gestion de usuarios" 

    busquedaResenasController -> busquedaResenasQueryService "Call service method"

    busquedaResenasController -> busquedaResenasCommandService "Call service method"

    busquedaResenasQueryService -> busquedaResenasRepository "Call repository method"

    busquedaResenasCommandService -> busquedaResenasRepository "Call repository method"

    busquedaResenasRepository -> busquedaResenaDB "Store, update, delete and fetch records - users" "SQL transaction"

     

    busquedaResenasQueryService -> busquedaResenasQuery "Handle query" 

    busquedaResenasCommandService -> busquedaResenasCommand "Handle command" 



    busquedaResenasCommandService -> googleMapsAPI "Call service method"

    busquedaResenasCommandService -> lecturaResenasCommandService "Call service method"
    ...
    # Relationship ComponentDiagram-lecturaResenas

    # --------------------------------------------------------

    apiGateway -> lecturaResenasController "Request Post del endpoint de gestion de usuarios" 

    lecturaResenasController -> lecturaResenasQueryService "Call service method"

    lecturaResenasController -> lecturaResenasCommandService "Call service method"

    lecturaResenasQueryService -> lecturaResenasRepository "Call repository method"

    lecturaResenasCommandService -> lecturaResenasRepository "Call repository method"

    lecturaResenasRepository -> lecturaResenasDB "Store, update, delete and fetch records - users" "SQL transaction"

     

    lecturaResenasQueryService -> lecturaResenasQuery "Handle query" 

    lecturaResenasCommandService -> lecturaResenasCommand "Handle command" 



    lecturaResenasCommandService -> googleTranslateAPI "Call service method"
  ...
  views {
    ...
    # View ComponentDiagram-busquedaEntidad

    # --------------------------------------------------------

    component busquedaResenasBC "ComponentDiagram-busquedaResenas" "Diagrama de Componentes de busqueda de Reseñas"{
    ...
    # View ComponentDiagram-lecturaResenas

    # --------------------------------------------------------

      component lecturaResenasBC "ComponentDiagram-lecturaResenas" "Diagrama de Componentes de lectura de Reseñas"{
